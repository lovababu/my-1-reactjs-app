               ...
               <div className="container">
                <div className="row">
                    <div className="col-xs-10 col-xs-offset-1">
                        <h2>Demonistrating how to invoke Parent Component method from Child Component in ReactJS.</h2>
                    </div>
                </div>
                <div className="row">
                    <div className="col-xs-10 col-xs-offset-1">
                ...
                <div className="row">
                    <div className="col-xs-10 col-xs-offset-1">
                        <button onClick= { this.props.greet } className="btn btn-primary">Call Parent</button>
                    </div>
                </div>
               </div>    
            );
